...
{
    public static string luaDir = Application.dataPath + "/../GameScripts";                //lua逻辑代码目录
    ...
    public static string luaResDir = string.Format("{0}/{1}/GameScripts", Application.persistentDataPath, osDir);      //手机运行时lua文件下载目录    
