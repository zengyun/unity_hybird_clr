...
public class UnityEngine_MonoBehaviourWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.MonoBehaviour), typeof(UnityEngine.Behaviour),"MonoBehaviour");
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_destroyCancellationToken(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			System.Threading.CancellationToken ret = obj.destroyCancellationToken;
			ToLua.PushValue(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index destroyCancellationToken on a nil value");
		}
	}
