...
public class UnityEngine_SystemInfoWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("foveatedRenderingCaps", get_foveatedRenderingCaps, null);
		...
		L.RegVar("maxTexture3DSize", get_maxTexture3DSize, null);
		L.RegVar("maxTextureArraySlices", get_maxTextureArraySlices, null);
		...
		L.RegVar("computeSubGroupSize", get_computeSubGroupSize, null);
		...
		L.RegVar("maxConstantBufferSize", get_maxConstantBufferSize, null);
		...
		L.RegVar("supportsMultisampleResolveStencil", get_supportsMultisampleResolveStencil, null);
		L.RegVar("supportsIndirectArgumentsBuffer", get_supportsIndirectArgumentsBuffer, null);
		L.EndStaticLibs();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_foveatedRenderingCaps(IntPtr L)
	{
		try
		{
			ToLua.Push(L, UnityEngine.SystemInfo.foveatedRenderingCaps);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_maxConstantBufferSize(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushinteger(L, UnityEngine.SystemInfo.maxConstantBufferSize);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_supportsMultisampleResolveStencil(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, UnityEngine.SystemInfo.supportsMultisampleResolveStencil);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_supportsIndirectArgumentsBuffer(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, UnityEngine.SystemInfo.supportsIndirectArgumentsBuffer);
			return 1;
		}
		catch (Exception e)
		{
