...
public class UnityEngine_AnimatorWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.Animator), typeof(UnityEngine.Behaviour),"Animator");
		...
		L.RegVar("avatarRoot", get_avatarRoot, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_avatarRoot(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Animator obj = (UnityEngine.Animator)o;
			UnityEngine.Transform ret = obj.avatarRoot;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index avatarRoot on a nil value");
		}
	}
