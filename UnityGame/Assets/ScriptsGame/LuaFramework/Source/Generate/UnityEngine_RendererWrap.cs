...
public class UnityEngine_RendererWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.Renderer), typeof(UnityEngine.Component),"Renderer");
		...
		L.RegFunction("SetSharedMaterials", SetSharedMaterials);
		L.RegFunction("SetMaterials", SetMaterials);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SetMaterials(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
