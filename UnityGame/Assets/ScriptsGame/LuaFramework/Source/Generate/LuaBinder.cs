...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		UnityEngine_ConstantForceWrap.Register(L);
		UnityEngine_ConstantForce2DWrap.Register(L);
		UnityEngine_ContactPointWrap.Register(L);
		UnityEngine_FontWrap.Register(L);
		UnityEngine_ForceModeWrap.Register(L);
		...
		UnityEngine_SimulationModeWrap.Register(L);
		...
		UnityEngine_TouchScreenKeyboardWrap.Register(L);
		...
		UnityEngine_Networking_MultipartFormDataSectionWrap.Register(L);
		...
		L.RegFunction("Action_UnityEngine_Tilemaps_Tilemap_Unity_Collections_NativeArray_UnityEngine_Vector3Int", System_Action_UnityEngine_Tilemaps_Tilemap_Unity_Collections_NativeArray_UnityEngine_Vector3Int);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_UnityEngine_Tilemaps_Tilemap_Unity_Collections_NativeArray_UnityEngine_Vector3Int(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<UnityEngine.Tilemaps.Tilemap,Unity.Collections.NativeArray<UnityEngine.Vector3Int>>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<UnityEngine.Tilemaps.Tilemap,Unity.Collections.NativeArray<UnityEngine.Vector3Int>>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
