...
public class UnityEngine_Networking_DownloadHandlerBufferWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.Networking.DownloadHandlerBuffer), typeof(UnityEngine.Networking.DownloadHandler),"DownloadHandlerBuffer");
	...
	static int Dispose(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Networking.DownloadHandlerBuffer obj = (UnityEngine.Networking.DownloadHandlerBuffer)ToLua.CheckObject(L, 1, typeof(UnityEngine.Networking.DownloadHandlerBuffer));
			obj.Dispose();
			return 0;
		}
		catch (Exception e)
