...
public class UnityEngine_RuntimeAnimatorControllerWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.RuntimeAnimatorController), typeof(UnityEngine.Object),"RuntimeAnimatorController");
	...
	static int get_animationClips(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index animationClips on a nil value");
		}
	}
}
