...
public class UnityEngine_SceneManagement_SceneManagerWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.SceneManagement.SceneManager), typeof(System.Object),"SceneManager");
		...
		L.RegFunction("MoveGameObjectsToScene", MoveGameObjectsToScene);
		...
		L.RegVar("loadedSceneCount", get_loadedSceneCount, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int MoveGameObjectsToScene(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			...
			UnityEngine.SceneManagement.Scene arg1 = StackTraits<UnityEngine.SceneManagement.Scene>.Check(L, 2);
			UnityEngine.SceneManagement.SceneManager.MoveGameObjectsToScene(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_loadedSceneCount(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushinteger(L, UnityEngine.SceneManagement.SceneManager.loadedSceneCount);
			return 1;
		}
		catch (Exception e)
		{
