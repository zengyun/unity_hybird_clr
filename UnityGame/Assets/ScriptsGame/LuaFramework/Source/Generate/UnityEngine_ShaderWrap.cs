...
public class UnityEngine_ShaderWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.Shader), typeof(UnityEngine.Object),"Shader");
		...
		L.RegFunction("GetPropertyDefaultIntValue", GetPropertyDefaultIntValue);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetPropertyDefaultIntValue(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Shader obj = (UnityEngine.Shader)ToLua.CheckObject(L, 1, typeof(UnityEngine.Shader));
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
			int o = obj.GetPropertyDefaultIntValue(arg0);
			LuaDLL.lua_pushinteger(L, o);
			return 1;
		}
		catch (Exception e)
