	...
	static int SetResolution(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				int arg0 = (int)LuaDLL.luaL_checknumber(L, 1);
				int arg1 = (int)LuaDLL.luaL_checknumber(L, 2);
				UnityEngine.FullScreenMode arg2 = (UnityEngine.FullScreenMode)ToLua.CheckObject(L, 3, typeof(UnityEngine.FullScreenMode));
				UnityEngine.RefreshRate arg3 = StackTraits<UnityEngine.RefreshRate>.Check(L, 4);
