...
public class UnityEngine_Video_VideoPlayerWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.Video.VideoPlayer), typeof(UnityEngine.Behaviour),"VideoPlayer");
		...
		L.RegVar("canSetTimeUpdateMode", get_canSetTimeUpdateMode, null);
	...
	static int get_timeUpdateMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			UnityEngine.Video.VideoTimeUpdateMode ret = obj.timeUpdateMode;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_canSetTimeUpdateMode(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			bool ret = obj.canSetTimeUpdateMode;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index canSetTimeUpdateMode on a nil value");
		}
	}
	...
	static int set_timeUpdateMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Video.VideoPlayer obj = (UnityEngine.Video.VideoPlayer)o;
			UnityEngine.Video.VideoTimeUpdateMode arg0 = (UnityEngine.Video.VideoTimeUpdateMode)ToLua.CheckObject(L, 2, typeof(UnityEngine.Video.VideoTimeUpdateMode));
