...
public class UnityEngine_ColliderWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.Collider), typeof(UnityEngine.Component),"Collider");
		...
		L.RegVar("providesContacts", get_providesContacts, set_providesContacts);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_providesContacts(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Collider obj = (UnityEngine.Collider)o;
			bool ret = obj.providesContacts;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index providesContacts on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_providesContacts(IntPtr L)
	{
		object o = null;
