...
public class UnityEngine_CollisionWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.Collision), typeof(System.Object),"Collision");
		...
		L.RegVar("articulationBody", get_articulationBody, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_articulationBody(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Collision obj = (UnityEngine.Collision)o;
			UnityEngine.ArticulationBody ret = obj.articulationBody;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index articulationBody on a nil value");
		}
	}
	...
	static int get_body(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Collision obj = (UnityEngine.Collision)o;
			UnityEngine.Component ret = obj.body;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
